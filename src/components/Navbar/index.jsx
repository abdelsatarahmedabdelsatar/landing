...
function Navbar() {
  ...
  const changeLang = (lng) => {
    lng == "en" ? updateLang("en") : updateLang("ar");
  ...
  return (
    <nav className="bg-[#06060696] px-3 py-2 fixed top-0 z-50 w-full shadow-xl">
      <div className=" mx-auto flex sm:justify-between  xs:justify-center items-center container  ">
        <div className="flex text-white xs:hidden sm:flex">
          <p className=" sm:pr-12  xs:pr-0 font-bold flex justify-between">
            <svg
              x="0px"
              y="0px"
              height="20"
